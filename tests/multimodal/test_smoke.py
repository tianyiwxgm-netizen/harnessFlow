...
def test_package_imports():
    ...
    import app.multimodal.common
    import app.multimodal.path_safety
    import app.multimodal.doc_io
    import app.multimodal.code_structure
    import app.multimodal.vision

...
consumer:
  - docs/3-2-Solution-TDD/L1-07-Harness监督/L2-02-tests.md（待建 · TC-L207-002-001~050）
---
...
- 3-2 Solution-TDD 层在 `docs/3-2-Solution-TDD/L1-07-Harness监督/L2-02-tests.md` 创建测试文件，以 TC-L207-002-001~050 为单测用例 ID。

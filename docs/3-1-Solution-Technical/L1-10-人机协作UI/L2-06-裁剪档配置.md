...
consumer:
  - docs/3-2-Solution-TDD/L1-10-人机协作UI/L2-06-tests.md（待建）
---
...
### 13.3 TDD 用例映射（指向 `docs/3-2-Solution-TDD/L1-10-人机协作UI/L2-06-tests.md`）
...
- **给 3-2 TDD 作者**：`docs/3-2-Solution-TDD/L1-10-人机协作UI/L2-06-tests.md` 需按本文 §13.3 的 15 个 TC 展开 · 每 TC 要求：Given（前置状态） + When（操作） + Then（≥ 3 断言 含性能断言）+ Mock 策略
- **给前端实现**：

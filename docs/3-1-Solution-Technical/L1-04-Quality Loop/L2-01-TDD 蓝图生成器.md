...
parent_doc:
  - docs/2-prd/L1-04 Quality Loop/prd.md（§5.4 L2-01 TDD 蓝图生成器）
...
traceability:
  prd_anchor: docs/2-prd/L1-04 Quality Loop/prd.md §5.4 L2-01
...
<!-- FILL §1 · 引用 2-prd/L1-04-Quality Loop/prd.md §5.4 L2-01 的职责定义，精确到小节的映射表。展开：本 L2 在本 L1 architecture.md 中的位置 · 与兄弟 L2 的边界 · PM-14 约束 · 关键技术决策（Decision→Rationale→Alternatives→Trade-off）-->

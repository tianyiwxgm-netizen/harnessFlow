...
| FIFO 自实现 = `Condition + deque` | ✅ | 本文 §6.1 · L0 可补 | **TODO 写回 L0**（§13 映射表跟踪）|
...
### 12.4 基准基线（实测 · 随 3-2 填充）

| 环境 | acquire P95 | release P95 | 10 方竞争 P95 | 20 方 10s 无饥饿? |
|---|---|---|---|---|
| macOS 14 / M2 / APFS | TBD | TBD | TBD | TBD |
| Ubuntu 22.04 / x86 / ext4 | TBD | TBD | TBD | TBD |
| Ubuntu 22.04 / arm64 / tmpfs | TBD | TBD | TBD | TBD |

（实测数据由 3-2 TDD 填入；本文档只定 SLO 目标）

...
### 13.1 prd §11.9 GWT 场景 → 本文档章节 → 3-2 TDD 用例

| prd §11.9 GWT 场景 | 本文章节 | 3-2 TDD 目标用例（路径 `docs/3-2-Solution-TDD/L1-09-韧性+审计/L2-04-tests.md`）| 期望断言要点 |
|---|---|---|---|
...
- [x] §1 定位 + 2-prd 映射（A1）· 覆盖 prd §11.1 / §11.4 / §11.9 + 5 条硬约束
